...
<p>
A search is saved and stored in the <b>Manage Queries</b> panel. Saved searches are also accessible within the <b>Load Save Queries</b> drop list located in the <b>Existing Queries</b> section of the Find Data Panel. Load Save Queries section stores the ten most recent saved searches.</p>
