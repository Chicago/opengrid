...
OpenGrid is designed to be flexible with different types of data sources. Whether it's MongoDB, a RESTful API, or other data sources, programmers can use [OpenGrid's API](../system-administration/opengrid-api.md#rest-service-resources) and Service Layer to program it to work with other data sources.
