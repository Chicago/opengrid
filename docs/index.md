...
OpenGrid is designed to be flexible with different types of data sources. Whether it's MongoDB, a RESTful API, or other data sources, programmers can use [OpenGrid's API](./docs/system-administration/opengrid-api.md) and [Service Layer](./docs/system-administration/installation-and-setup.md#service-layer) to program it to work with other data sources.
