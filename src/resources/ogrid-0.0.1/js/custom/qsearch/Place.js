...
ogrid.QSearchProcessor.Place = ogrid.QSearchProcessor.extend({
    ...
    exec: function(onSuccess, onError) {
        ...
        var txt = encodeURI(this._input);
        $.ajax({
            //use ArcGIS online's geocoder server
            url: 'http://geocode.arcgis.com/arcgis/rest/services/World/GeocodeServer/find?outSr=4326&forStorage=false&outFields=*&maxLocations=20&text=' + txt + '&magicKey=GST7YMc0AM9UOsE3GY8tIS9GOghnYnwZGPTp7P9PCZc0YiD7DsKGCZyAOh5-Dn47Z5Et1bWtHghnCbWQ&f=json',
            type: 'GET',
            async: true,
